      ...
      <div class="col-wide grid grid-cols-subgrid justify-items-center gap-fluid-md p-fluid-lg bg-surface rounded-lg">
        ...
        <div class="col-wide flex gap-4 items-center flex-col sm:flex-row">
         <a href="https://vite.dev" target="_blank">
            <img src="${a}" class="logo" alt="Vite logo" width="50" />
          </a>
          <a href="https://www.typescriptlang.org/" target="_blank">
            <img src="${r}" class="logo vanilla" alt="TypeScript logo" width="50" />
          </a>
        </div>
      </div>  
...
`;function n(o){o.addEventListener("submit",s=>{s.preventDefault();const i=new FormData(o),l=Object.fromEntries(i.entries());console.log(l)})}n(document.querySelector("#registerForm"));
