...
`;function s(e){e.addEventListener(`submit`,t=>{t.preventDefault();let n=new FormData(e),r=Object.fromEntries(n.entries());console.log(r)})}a(`p-select[name="color-scheme"]`),s(document.querySelector(`#registerForm`));