...
`;function n(l){l.addEventListener("submit",o=>{o.preventDefault();const i=new FormData(l),s=Object.fromEntries(i.entries());console.log(s)})}n(document.querySelector("#registerForm"));
