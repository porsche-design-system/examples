      ...
      <div class="col-wide grid grid-cols-subgrid justify-items-center gap-fluid-md p-fluid-lg bg-surface rounded-4xl">
        ...
        <div class="col-wide flex gap-4 items-center flex-col sm:flex-row">
         <a href="https://vite.dev" target="_blank">
            <img src="${e}" class="logo" alt="Vite logo" width="50" />
          </a>
          <a href="https://www.typescriptlang.org/" target="_blank">
            <img src="${o}" class="logo vanilla" alt="TypeScript logo" width="50" />
          </a>
        </div>
      </div>  
...
`;function s(e){e.addEventListener(`submit`,t=>{t.preventDefault();let n=new FormData(e),r=Object.fromEntries(n.entries());console.log(r)});let t=document.querySelector(`p-select[name="theme"]`),n=localStorage.getItem(`theme`);n&&(t.value=n,document.documentElement.classList.remove(`light`,`dark`,`auto`),document.documentElement.classList.add(n)),t?.addEventListener(`change`,e=>{let t=e.target.value;document.documentElement.classList.remove(`light`,`dark`,`auto`),document.documentElement.classList.add(t),localStorage.setItem(`theme`,t)})}a(`p-select[name="theme"]`),s(document.querySelector(`#registerForm`));